...
<div class="w3-display-container w3-text-white">
    <div class="w3-display-topleft w3-container w3-xlarge">
        <form action="/actionFilter" method="get">
        <p><button type="submit" value="access" id="accessButton" onclick="document.getElementById('access').style.display='block'" class="w3-button w3-black">Authenticate</button></p>
        <p><button type="submit" value="spin" id="spinButton" onclick="document.getElementById('spin').style.display='block'" class="w3-button w3-black">Give it a spin</button></p>
        <p><button type="submit" value="about" id="aboutButton" onclick="document.getElementById('about').style.display='block'" class="w3-button w3-black">About Trek Roulette</button></p>
        </form>
    </div>
